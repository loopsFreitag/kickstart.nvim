...
vim.keymap.set('n', '<S-f>', ':Telescope live_grep<CR>', { noremap = true, silent = true })
...
-- For visual mode (commenting selected text)
vim.keymap.set(
  'x',
  '<leader>/',
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'java' }, -- Autoinstall languages that are not installed
      auto_install = true,
      highlight = {
        enable = true,
