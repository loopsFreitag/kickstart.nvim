...
vim.api.nvim_create_autocmd('BufEnter', {
  ...
  callback = function()
    ...
    if #layout == 1 and vim.api.nvim_buf_get_name(vim.api.nvim_win_get_buf(layout[1])):match 'NvimTree_' then
      vim.cmd 'quit'
    end
  end,
})
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      require('nvim-tree').setup {
        ...
        update_focused_file = {
          enable = true,
          update_root = false, -- set true if you want cwd to change too
        },
      }
  ...
  -- Local Kickstart plugins
  require 'kickstart.plugins.debug',
  require 'kickstart.plugins.autopairs',
}, {
  ui = { icons = vim.g.have_nerd_font and {} or { cmd = '⌘', config = '🛠' } },
})
